...
ARTICLE_URL_RE = re.compile(
    r"/(20\d{2}/\d{2}/|bank[-/]|question[-/]|exam[-/]|solution[-/]|mcq[-/]|written[-/]|officer[-/]|job[-/])",
    re.I,
)
...
class BankCrawler:
    ...
    def _crawl_site(self, target: dict) -> list[dict]:
        ...
        logger.info(f"[Bank] Found {len(sub_links)} article links on {target['name']}")
